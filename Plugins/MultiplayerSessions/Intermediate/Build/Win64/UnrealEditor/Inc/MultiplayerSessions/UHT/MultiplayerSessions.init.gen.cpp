	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_MultiplayerSessions()
	{
		if (!Z_Registration_Info_UPackage__Script_MultiplayerSessions.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_MultiplayerSessions_MultiplayerCreateSession__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_MultiplayerSessions_MultiplayerDestroySession__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_MultiplayerSessions_MultiplayerStartSession__DelegateSignature,
			};
